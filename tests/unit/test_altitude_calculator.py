import pytest
from pyscuba.calculators.altitude_calculator import AltitudeCalculator
from pyscuba.physics.pressure_converter import PressureConverter, AltitudePressure
